...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/mute-mode-a1d5
```

A live public deployment of this template is available at [https://mute-mode-a1d5.templates.workers.dev](https://mute-mode-a1d5.templates.workers.dev)
